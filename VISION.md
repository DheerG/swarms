...
2. **Roles**: every team has a lead, a facilitator, and specialists. Quality enforcement is a shared responsibility: the facilitator ensures the team defines what done looks like during convergence, the lead invokes `/swarm:define-rubric` when no existing standards apply, and all members validate output against the agreed criteria during review.
